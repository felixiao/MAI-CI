...
methods
    ...
    function obj = ShowResult(obj)
        fprintf('Train Result:\tCount= %d\tMatches= %d\tAccuracy= %.2f\tPerformance= %.2f\n',length(obj.TR.trainInd),obj.Matches_Train,obj.Accuracy_Train,obj.Perform_Train);
        fprintf('Val   Result:\tCount= %d\tMatches= %d\tAccuracy= %.2f\tPerformance= %.2f\n',length(obj.TR.trainInd),obj.Matches_Train,obj.Accuracy_Train,obj.Perform_Train);
        fprintf('Test  Result:\tCount= %d\tMatches= %d\tAccuracy= %.2f\tPerformance= %.2f\n',length(obj.TR.trainInd),obj.Matches_Train,obj.Accuracy_Train,obj.Perform_Train);
